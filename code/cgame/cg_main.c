...
cvar_t *cg_readablefeed;
cvar_t *cg_readablefeed_scale;
cvar_t *cg_drawsvlag;
cvar_t *cg_crosshair;
...
void CG_RegisterCvars(void)
{
    ...
    cg_readablefeed               = cgi.Cvar_Get("cg_readablefeed", "1", CVAR_ARCHIVE);
    cg_readablefeed_scale         = cgi.Cvar_Get("cg_readablefeed_scale", "1.6", CVAR_ARCHIVE);
